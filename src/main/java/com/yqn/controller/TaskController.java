...
public class TaskController {
    ...
    public Map<String, Object> saveTask(Task task) {
        ...
        if (user.getBalance() >= task.getReward()) {
            ...
            if (save) {
                money.transfer("balance=balance-", task.getReward(), user.getUserId());
            }
    ...
    public Map<String, Object> delTask(@PathVariable Long id) {
        ...
        if (task != null) {
            ...
            money.transfer("balance=balance+", task.getReward(), task.getPublish().getUserId());
        }
    ...
    public Map<String, Object> missionCompleted(@PathVariable Long id) {
        ...
        if (b) {
            Task task = taskService.getById(id);
            if (task != null) {
                money.transfer("balance=balance+", task.getReward(), task.getAccept().getUserId());
            }
