...
<div class="">
    <div class="content" :class="isShow?'s--signup':''" >
        <div class="form">
            ...
            <label>
                <span>学号(纯数字)</span>
                <input type="text" v-model="userId" oninput="value=value.replace(/[^\d]/g,'')"/>
            </label>
            <label>
                <span>密码</span>
            ...
            <label>
                <span style="margin-bottom: 20px">选择学区</span>
            </label>
                            ...
                            this.$get("/user/login",
                                ...
                                if (res.data.status) {
                                    if (res.data.user.state == 0) {
                                        let accountOrName = res.data.user.username ? res.data.user.username : res.data.user.userId;
